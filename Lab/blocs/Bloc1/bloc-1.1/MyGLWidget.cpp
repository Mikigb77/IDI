...
void MyGLWidget::paintGL()
{
  ...
  // Pintem l'escena
  glDrawArrays(GL_TRIANGLES, 0, 3 * numTriang);
...
{
  numTriang = 3;
  glm::vec3 Vertices[3 * numTriang]; // Tres vèrtexs amb X, Y i Z
  ...
  Vertices2[1] = glm::vec3(-0.5, -1, 0.0);
