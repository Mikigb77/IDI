...
void MyGLWidget::paintGL()
{
  ...
  // inicialitzem la transformació de la matriu
  modelTransform();
...
void MyGLWidget::creaBuffers()
{
  ...
  glm::vec3 Colors2[3];
  Colors2[0] = glm::vec3(0, 0, 1);
  Colors2[1] = glm::vec3(0, 1, 0);
  Colors2[2] = glm::vec3(1, 0, 0);
...
{
  glm::mat4 TG(1.f);
  TG = glm::translate(TG, locVector);
  TG = glm::rotate(TG, rotation, glm::vec3(0.f, 0.f, 1.f));
...
void MyGLWidget::modelTransform2()
{
  glm::mat4 TG(1.f);
  TG = glm::translate(TG, locVector);
  TG = glm::rotate(TG, rotation2, glm::vec3(0.f, 0.f, 1.f));
  TG = glm::scale(TG, glm::vec3(scl));
  glUniformMatrix4fv(transLoc, 1, GL_FALSE, &TG[0][0]);
}
